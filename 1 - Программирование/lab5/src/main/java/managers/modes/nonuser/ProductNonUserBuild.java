...
import managers.validators.coordinates.CoordinatesXValidator;
import managers.validators.coordinates.CoordinatesYValidator;
 ...
 */
public class ProductNonUserBuild implements Buildingable<Product> {
    ...
    public Product buildObject() throws BuildObjectException {
        ...
        try {
            //id
            Integer id = ProductIdManager.generateId();
            result.setId(id);
