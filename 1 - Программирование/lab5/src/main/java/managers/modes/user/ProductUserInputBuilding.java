...
import managers.validators.ProductManufactureCostValidator;
import managers.validators.ProductNameValidator;
import managers.validators.ProductPartNumberValidator;
import managers.validators.ProductPriceValidator;
 ...
 */
public class ProductUserInputBuilding implements Buildingable<Product> {
    ...
    public Product buildObject() throws BuildObjectException {
        ...
        try {
            ...
            product.setId(ProductIdManager.generateId());
